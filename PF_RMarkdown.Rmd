...
Como parte del analisis exploratorio, se hicieron distintas visualizaciones que nos ayudaran a tener una idea sobre la informacion que se refleja en las encuentas.

Tambien como un primer acercamiento al analisis inferencial, que pudiese ser aplicado en un estudio mas profundo, se hicieron distintas regresiones sobre la data para ver que sugerían los coeficientes.
