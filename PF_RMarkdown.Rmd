...
### **4. Relacion entre el PIB per-cápita y la felicidad**
...
En el presente apartado se realizara una descripcion de los aspectos mas destacados de la relacion entre PIB per-cápita y la felicidad. En primer lugar, para determinar esto se hizo uso del **modelo de regresión lineal**, cuya función es reflejar la dependencia que existe entre las dos variables, en este caso sería entre el PIBpc y el puntaje de la felicidad. Luego se procedió a hacer el gráfico con la función de ggplot, al igual que todos los gráficos anteriores, el cual **demostró que existe una correlación positiva**. Esto último implica que a medida que crece el PIB per cápita, aumentará el puntaje de la felicidad. Además, se estimaron los siguientes indicadores:
